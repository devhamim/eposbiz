                                    ...
                                    <table class="table table-summary table-responsive">
                                        ...
                                        <tbody class="mt-5">
                                                ...
                                                <tr class="table-shadow">
                                                    ...
                                                    <td>
                                                        <div class="product_info">
                                                            ...
                                                            <?php endif; ?>
                                                            <?php if(isset($data['item_color']) && $data['item_color'] !== null): ?>
                                                                <span>Color: <?php echo e($data['item_color']); ?></span>
                                                            <?php endif; ?>
                                                            <?php if(isset($data['item_size']) && $data['item_size'] !== null): ?>
                                                                <span>Size: <?php echo e($data['item_size']); ?></span>
                                                            <?php endif; ?>
                                                        </div>
                                                    ...
                                                    <td>
                                                        <div class="cart-product-quantity">
                                                            ...
                                                            <span class="subtotal">Tk <?php echo e(($data['item_quantity'] ?? 1) * ($data['item_price'] ?? $data['product_price'])); ?></span>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <?php
                                            ...
                                            <tr class="summary-total checkout_bottom_border">
                                                ...
                                                <td></td>
                                                <td></td>
                                                <td class="grand_total_price">Tk <?php echo e($total); ?></td>
                                            </tr>
                                            ...
                                            <tr class="summary-total delivery-charge-row checkout_bottom_border">
                                                ...
                                                <td></td>
                                                <td></td>
                                                <td class="grand_total"><span class="grand_span">Tk <?php echo e($total); ?></span></td>
                                            </tr>
